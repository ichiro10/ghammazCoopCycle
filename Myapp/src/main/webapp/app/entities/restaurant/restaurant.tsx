  ...
  return (
    <div>
      <h2 id="restaurant-heading" data-cy="RestaurantHeading">
        <Translate contentKey="ghammazApp.restaurant.home.title">Restaurants</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ghammazApp.restaurant.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/restaurant/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ghammazApp.restaurant.home.createLabel">Create new Restaurant</Translate>
          </Link>
        </div>
      </h2>
        ...
        {restaurantList && restaurantList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="ghammazApp.restaurant.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="ghammazApp.restaurant.idRest">Id Rest</Translate>
                </th>
                <th>
                  <Translate contentKey="ghammazApp.restaurant.nomRest">Nom Rest</Translate>
                </th>
                <th>
                  <Translate contentKey="ghammazApp.restaurant.adresseRest">Adresse Rest</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ghammazApp.restaurant.home.notFound">No Restaurants found</Translate>
            </div>
          )
        )}
      </div>
