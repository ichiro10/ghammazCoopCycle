  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ghammazApp.restaurant.home.createOrEditLabel" data-cy="RestaurantCreateUpdateHeading">
            <Translate contentKey="ghammazApp.restaurant.home.createOrEditLabel">Create or edit a Restaurant</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ghammazApp.restaurant.idRest')}
              ...
              />
              <ValidatedField
                label={translate('ghammazApp.restaurant.nomRest')}
              ...
              />
              <ValidatedField
                label={translate('ghammazApp.restaurant.adresseRest')}
