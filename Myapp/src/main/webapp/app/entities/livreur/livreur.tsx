  ...
  return (
    <div>
      <h2 id="livreur-heading" data-cy="LivreurHeading">
        <Translate contentKey="ghammazApp.livreur.home.title">Livreurs</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ghammazApp.livreur.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/livreur/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ghammazApp.livreur.home.createLabel">Create new Livreur</Translate>
          </Link>
        </div>
      </h2>
        ...
        {livreurList && livreurList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="ghammazApp.livreur.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="ghammazApp.livreur.idLivreur">Id Livreur</Translate>
                </th>
                <th>
                  <Translate contentKey="ghammazApp.livreur.nomLivreur">Nom Livreur</Translate>
                </th>
                <th>
                  <Translate contentKey="ghammazApp.livreur.prenomLivreur">Prenom Livreur</Translate>
                </th>
                <th>
                  <Translate contentKey="ghammazApp.livreur.telLivreur">Tel Livreur</Translate>
                </th>
                <th>
                  <Translate contentKey="ghammazApp.livreur.association">Association</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ghammazApp.livreur.home.notFound">No Livreurs found</Translate>
            </div>
          )
        )}
      </div>
