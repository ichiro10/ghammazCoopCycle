...
import ghammaz.coopcycle.repository.ProduitRepository;
import ghammaz.coopcycle.service.ProduitService;
...
/**
 * REST controller for managing {@link ghammaz.coopcycle.domain.Produit}.
 */
@RestController
@RequestMapping("/api")
