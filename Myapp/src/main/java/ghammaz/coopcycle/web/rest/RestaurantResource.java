...
import ghammaz.coopcycle.repository.RestaurantRepository;
import ghammaz.coopcycle.service.RestaurantService;
...
/**
 * REST controller for managing {@link ghammaz.coopcycle.domain.Restaurant}.
 */
@RestController
@RequestMapping("/api")
