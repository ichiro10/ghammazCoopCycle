package ghammaz.coopcycle.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ghammaz.coopcycle.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ghammaz.coopcycle.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
